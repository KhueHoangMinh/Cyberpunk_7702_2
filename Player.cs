...
namespace Cyberpunk77022
{
    public class Player : Object
    {
        ...
        bool _jumped = false;
        Gun _PlayerGun;
        public Player(Window window, Camera camera, Point2D pos, float sizeX, float sizeY, Color color) : base(camera, pos, sizeX,sizeY,color,true,0,0) { 
            _PlayerGun = new Gun(window, this, camera);
        }

                    ...
                    while (true)
                    {
                        ...
                        if (server)
                        {
                            ...
                            if (received[0] == "1")
                            {
                                ...
                                {
                                    prevTicks = long.Parse(received[3]);
            ...
            new Thread(() =>
            {
                ...
                if (server)
                {
                    while (true)
                    {
                        ...
                        byte[] sendbuf = Encoding.ASCII.GetBytes("0" + "," + player.Pos.X.ToString() + "," + player.Pos.Y.ToString() + "," + sequence.ToString() + "," + dir1.ToString() + dir2.ToString() + dir3.ToString());
